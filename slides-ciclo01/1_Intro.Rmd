...
knitr::include_graphics("images/01-RConsole.jpg")
```
...
knitr::include_graphics("images/IDERS.png")
```
...
```{r, echo=FALSE, out.width="415px", out.height="500px"}
knitr::include_graphics("images/cover_sm.png")
```
